...
export const testimonials5 = [
  {
    text: "A voice to hear when silence feels too heavy.",
    author: "Thomas Johnson",
  ...
  {
    text: "A message to read when the world feels too distant.",
    author: "Emma Kande",
    position: "3D Artist",
  ...
  {
    text: "A presence that lingers, not as an illusion, but as love carried forward.",
    author: "Peter Rebel",
  ...
  {
    text: "Because to be remembered is to live on. Start preserving the voices that matter today.",
    author: "Alice Watson",
