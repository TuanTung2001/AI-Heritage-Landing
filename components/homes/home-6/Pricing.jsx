      ...
      <div className="row mb-50 mb-sm-30">
        <div className="col-md-8 offset-md-2 text-center">
          ...
          <h3 className="section-title mb-0">
            Some moments are too precious to be lost. Some voices deserve to be
            heard forever.
          </h3>
        </div>
      </div>
        ...
        <div className="col-xl-10 offset-xl-1">
          ...
          <div className="mb-60 mb-sm-40 text-center">
            ...
            <div className="small text-gray mt-10">
              Starting at just
              <strong>$500</strong> – A small price for something truly
              priceless.
              <br />
              <strong>Because every story is deeply personal, we limit this service to just 5 families per month.</strong>
            </div>
          </div>
          {/* End Nav Tabs */}
          {/* Tab panes */}
